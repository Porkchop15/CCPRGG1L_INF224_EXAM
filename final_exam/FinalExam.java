    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int rows = 0; rows < array.length; rows++){
            ...
            for (int column = 0; column < array.length; column++){
                ...
                else if(rows == 2 && (column == 0 || column == 1 || column == 2 || column == 3 || column == 4 || column == 5 || column == 6 || column == 7 || column == 9 || column == 10 || column == 11 || column == 12 || column == 13 || column == 14 )){
                    System.out.print(" ");
                }
                else if(rows == 3 && (column == 0 || column == 1 || column == 2 || column == 3 || column == 4 || column == 5 || column == 6 || column == 7 || column == 9 || column == 10 || column == 11 || column == 12 || column == 13 || column == 14 )){
                    System.out.print(" ");
                }
                else if(rows == 4 && (column == 0 || column == 1 || column == 2 || column == 3 || column == 4 || column == 5 || column == 6 || column == 7 || column == 9 || column == 10 || column == 11 || column == 12 || column == 13 || column == 14 )){
                    System.out.print(" ");
                }
                else if(rows == 5 && (column == 0 || column == 1 || column == 2 || column == 3 || column == 4 || column == 5 || column == 6 || column == 7 || column == 9 || column == 10 || column == 11 || column == 12 || column == 13 || column == 14 )){
                    System.out.print(" ");
                }
                else if(rows == 6 && (column == 0 || column == 1 || column == 2 || column == 3 || column == 4 || column == 5 || column == 6 || column == 7 || column == 9 || column == 10 || column == 11 || column == 12 || column == 13 || column == 14 )){
                    System.out.print(" ");
                }
                else if(rows == 7 && (column == 0 || column == 1 || column == 2 || column == 3 || column == 4 || column == 5 || column == 6 || column == 7 || column == 9 || column == 10 || column == 11 || column == 12 || column == 13 || column == 14 )){
                    System.out.print(" ");
                }
                else if(rows == 8 && (column == 0 || column == 1 || column == 2 || column == 3 || column == 4 || column == 5 || column == 6 || column == 7 || column == 9 || column == 10 || column == 11 || column == 12 || column == 13 || column == 14 )){
                    System.out.print(" ");
                }
                else if(rows == 9){
                    System.out.print(" ");
        ...
        for (int rows = 0; rows < array.length; rows++){
            System.out.println(" ");
            for (int column = 0; column < array.length; column++){
                if (rows == 1 && column == 1 || rows == 2 && column == 2 || rows == 3 && column == 3 || rows == 4 && column == 4 || rows == 5 && column == 5 || rows == 6 && column == 6 || rows == 7 && column == 7 || rows == 8 && column == 8 || rows == 9 && column == 9){
                    System.out.print(array[rows][column]);
                }
                else{
                    System.out.print(" "); 
        ...
        for (int rows = 0; rows < array.length; rows++){
            System.out.println(" ");
            for (int column = 0; column < array.length; column++){
                if (rows == 13 && (column == 2 || column == 3 || column == 4 || column == 5 || column == 6 || column == 7 || column == 8)){
                    System.out.print(array[rows][column]);
                }
                else{
                    System.out.print(" "); 
        ...
        for (int rows = 0; rows < array.length; rows++){
            System.out.println(" ");
            for (int column = 0; column < array.length; column++){
                if (column == 1 && (rows == 8 || rows == 9 || rows == 10 || rows == 11 || rows == 12 || rows == 13 || rows == 14)){
                    System.out.print(array[rows][column]);
                }
                else{
                    System.out.print(" "); 
        ...
        for (int rows = 0; rows < array.length; rows++){
            System.out.println(" ");
            for (int column = 0; column < array.length; column++){
                if (rows == 10 && column == 7 || rows == 9 && column == 8 || rows == 8 && column == 9 || rows == 7 && column == 10 || rows == 6 && column == 11 || rows == 5 && column == 12 || rows == 4 && column == 13 || rows == 3 && column == 14){
                    System.out.print(array[rows][column]);
                }
                else{
                    System.out.print(" "); 
        ...
        for (int rows = 0; rows < array.length; rows++){
            System.out.println(" ");
            for (int column = 0; column < array.length; column++){
                if (rows == 5 && column == 0 || rows == 6 && column == 1 || rows == 7 && column == 2 || rows == 8 && column == 3 || rows == 9 && column == 4 || rows == 10 && column == 5){
                    System.out.print(array[rows][column]);
                }
                else{
                    System.out.print(" "); 
        ...
        for (int rows = 0; rows < array.length; rows++){
            System.out.println(" ");
            for (int column = 0; column < array.length; column++){
                if (rows == 12 && (column == 7 || column == 8 || column == 9 || column == 10 || column == 11 || column == 12 || column == 13 || column == 14)){
                    System.out.print(array[rows][column]);
                }
                else{
                    System.out.print(" "); 
        ...
        for (int rows = 0; rows < array.length; rows++){
            System.out.println(" ");
            for (int column = 0; column < array.length; column++){
                if (rows == 0 && column == 9 || rows == 1 && column == 8 || rows == 2 && column == 7 || rows == 3 && column == 6 || rows == 4 && column == 5 || rows == 5 && column == 4){
                    System.out.print(array[rows][column]);
                }
                else{
                    System.out.print(" "); 
        ...
        for (int rows = 0; rows < array.length; rows++){
            System.out.println(" ");
            for (int column = 0; column < array.length; column++){
                if (rows == 6 && column == 0 || rows == 7 && column == 1 || rows == 8 && column == 2 || rows == 9 && column == 3 || rows == 10 && column == 4){
                    System.out.print(array[rows][column]);
                }
                else{
                    System.out.print(" "); 
        ...
        for (int rows = 0; rows < array.length; rows++){
            System.out.println(" ");
            for (int column = 0; column < array.length; column++){
                if (column == 14 && (rows == 4 || rows == 5 || rows == 6 || rows == 7 || rows == 8 || rows == 9 || rows == 10 || rows == 11 || rows == 12 )){
                    System.out.print(array[rows][column]);
                }
                else{
                    System.out.print(" "); 
