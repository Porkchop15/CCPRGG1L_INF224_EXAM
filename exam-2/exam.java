...
public class Exam {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("The sum of the character length of your first name and surname is: " + (firstname + surname)); 
       ...
       // 8. Create a nested condition that will ask the specialization of the student
        ...
        static void EmailAdd(){
            ...
            if (studentEmailAddress.contains("reyes") && studentEmailAddress.contains("@students.national-u.edu.ph")) {
                System.out.println("valid");
                } else {
                System.out.println("invalid");
                }
